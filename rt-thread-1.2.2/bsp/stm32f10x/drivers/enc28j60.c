...
//    GPIO_Init(GPIOA, &GPIO_InitStructure);	
//    
//    GPIO_EXTILineConfig(GPIO_PortSourceGPIOA, GPIO_PinSource1); // 外部中断配置PA1
//    
...
static void SPI_Disable_OtherDev(void)
{
    GPIO_InitTypeDef GPIO_InitStructure;
    ...
    //PB12 VS1003 SPI片选（V2.1) PB7触摸屏芯片XPT2046 SPI 片选
