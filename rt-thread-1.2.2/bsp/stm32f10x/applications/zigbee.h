...
#define CID_KEYRELAY_KEYON        0x01  //按键开
#define CID_KEYRELAY_KEYOFF       0x02  //按键关
#define CID_KEYRELAY_RELAYON      0x03  //继电器开
#define CID_KEYRELAY_RELAYOFF     0x04  //继电器关
#define CID_KEYRELAY_GETKEY       0x05  //获取按键状态
#define CID_KEYRELAY_GETRELAY     0x06  //获取按键状态
