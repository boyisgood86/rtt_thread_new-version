...
typedef struct
{
    uint8  CtrlSelect;      //设备选择: (0701按键开)  1-KEY1;2-KEY2;3-KEY3;4-KEY4;5-KEY5;
                            //设备选择: (0703继电器开)1-RELAY1;2-RELAY1;
    uint8  CtrlVal;         //控制值:0-关；100开；
    uint8  Reserved[2];     //保留位-可以作为亮度调节
}KeyRelay_t;
