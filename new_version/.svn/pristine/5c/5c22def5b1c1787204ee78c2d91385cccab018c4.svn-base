...
/* read cmd from uart1 and send cmd to uart2 */
static void uart1_read_write_thread(void *arg)
{
  while(1) {
    rt_thread_delay(200);
    uart1_user_cmd_do();
...
//        mkfs("elm", "flash0");
    ...
    #ifdef UDP_SERVER
          sys_thread_new("udp_server", udp_server_thread, NULL, TCPIP_THREAD_STACKSIZE, (TCPIP_THREAD_PRIO+1));    
    #endif /* UDP_SERVER */
...
#ifdef UART_USING
     sys_thread_new("uart_read", uart_read_from_zigbee_thread, NULL, TCPIP_THREAD_STACKSIZE, (TCPIP_THREAD_PRIO-1));
     sys_thread_new("uart_write", uart_send_cmd_to_zigbee_thread, NULL, TCPIP_THREAD_STACKSIZE, TCPIP_THREAD_PRIO);
#endif /* UART_USING */

#if _DEUBG
     sys_thread_new("uart1_read_write", uart1_read_write_thread, NULL, TCPIP_THREAD_STACKSIZE, (TCPIP_THREAD_PRIO-1));
#endif             
