...
#define YM_SOCKET           (4)
#define YM_SWITCH           (5)
#define YM_CURTAINS         (6)

/*switch type*/
#define YM_SWITCH_ONE       (1)
#define YM_SWITCH_TWO       (2)
#define YM_SWITCH_THREE     (3)
#define YM_SWITCH_FOUR      (4)
#define YM_SWITCH_FIVE      (5)
